...
class CrunchStatisticsMy implements ShouldQueue
{
    use Dispatchable;
    ...
    {
//        Datum::orderBy('id', 'desc')->limit(1)->get()->each(function ($item) {
//        app('metrika.datum')->each(function ($item) {
//        app('metrika.datum')->where('id', '>', 168690)->limit(1)->get()->each(function ($item) {
        app('metrika.datum')->limit(100)->get()->each(function ($item) {
            try {
